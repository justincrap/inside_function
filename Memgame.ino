 int ledArray[] = {23,22,38};// ledArray[0] is green, ledArray[1] is red, ledArray[2] is yellow, and ledArray[3] is blue. 
 int buttonArray[] = {53,52,50};// buttonArray[0] is green, buttonArray[1] is red, buttonArray[2] is yellow, and buttonArray[3] is blue. 

//g,r,b
 int pinCount = 3; //both ledArray and buttonArray have same pinCount --> use this for both buttons and leds
 int buzzer = 8;
